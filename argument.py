...
parser.add_argument(
    "--train-dir",
    type=str,
    default="/root/autodl-tmp/RDED-main/dataset/imagenet/train/",
...
parser.add_argument(
    "--val-dir",
    type=str,
    default="/root/autodl-tmp/RDED-main/dataset/imagenet/val/",
...
args.train_dir = "/root/autodl-tmp/RDED-main/dataset/imagenet/train"# f"./data/{args.subset}/train/"
args.val_dir = "/root/autodl-tmp/RDED-main/dataset/imagenet/val"#f"./data/{args.subset}/val/"
